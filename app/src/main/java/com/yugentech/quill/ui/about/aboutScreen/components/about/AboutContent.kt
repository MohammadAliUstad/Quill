...
object AboutContent {
    ...
    fun getSupportItems(
        context: Context,
        onDonateClick: () -> Unit
    ): List<com.yugentech.quill.ui.about.aboutScreen.components.about.AboutOption> {
        return listOf(
            _root_ide_package_.com.yugentech.quill.ui.about.aboutScreen.components.about.AboutOption(
    ...
    fun getCommunityItems(context: Context): List<com.yugentech.quill.ui.about.aboutScreen.components.about.AboutOption> {
        return listOf(
            _root_ide_package_.com.yugentech.quill.ui.about.aboutScreen.components.about.AboutOption(
                title = "Rate this App",
