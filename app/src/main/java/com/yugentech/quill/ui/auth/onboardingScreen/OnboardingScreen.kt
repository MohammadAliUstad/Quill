package com.yugentech.quill.ui.auth.onboardingScreen
...
import com.yugentech.quill.ui.auth.components.WavyBackground
...
fun OnboardingPage(page: Int, isVisible: Boolean) {
    ...
    Column(
        ...
        AnimatedVisibility(
            ...
            enter = fadeIn(tween(AppAnimations.Durations.Complex)) + slideInVertically(
                tween(
                    AppAnimations.Durations.Complex
                )
            ) { AppAnimations.Durations.Micro },
            exit = fadeOut()
        ) {
            Column(
